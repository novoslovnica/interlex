...
export default async function AdminAntonymsPage() {
    ...
    const relationsByMeaning = fetchSymmetricSemanticRelations(dbSimple, "antonym", allMeaningIds)
    ...
    async function updateAntonyms(sourceMeaningId: number, targetMeaningIds: number[]) {
        ...
        saveSymmetricSemanticRelation(dbSimple, "antonym", sourceMeaningId, targetMeaningIds, 1.0)
