...
const navItems: NavEntry[] = [
    { href: "/admin", label: "Главная", roles: ["ADMIN", "MODERATOR"] },
    {
        ...
        children: [
            ...
            { href: "/admin/proper-nouns", label: "Имена собственные", roles: ["ADMIN", "MODERATOR"], feature: Feature.WordsEdit },
    ...
    },
    {
        ...
        children: [
            ...
            { href: "/admin/community-review", label: "Ответы сообщества", roles: ["ADMIN", "MODERATOR"], feature: Feature.CommunityReview },
